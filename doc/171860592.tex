...
\subsection{项目框架}
这一部分基于课程给出的框架, 做了比较大的修改, 在这里主要描述我添加的部分
\begin{itemize}
  \item 整体布局
  \begin{figure}[htp]
    \centering
  ...
  \begin{figure}[htp]
    \centering
    \includegraphics[width=12cm]{asset/03.png}
    \caption{窗口布局, 蓝色为QHboxLayout, 绿色为QVboxLayout, 黄色为QWidget}
    \end{figure}
  \item MainWindow: 主窗口类, 构建界面, 主要的代码功能如下\begin{itemize}
    \item 为整个窗体设置StyleSheet, 
  \end{itemize}
  \item 
\end{itemize}
